...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Last Prompt: Lockwood — Historical Decision Practice",
...
const schema = {
  ...
  "description": "A historical decision practice across six crux points in the development of computing and machine intelligence (1936–1948). Practitioners reason as The Traveller — a silent operative who intervenes via The Whisper.",
