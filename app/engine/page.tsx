...
import { Cpu, Layers, Lock, Brain, Zap, ArrowRight, Globe, Atom } from "lucide-react";
...
export default function EnginePage() {
    return (
        <div className="pt-16 overflow-x-hidden">
            ...
            {/* ── CHRONOSYMBIOSIS + OPH ── */}
            <section className="py-20 bg-[#050810] border-b border-gray-900">
                <div className="max-w-[1200px] mx-auto px-4 sm:px-6">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                        <motion.div
                            initial={{ opacity: 0, y: 20 }}
                        ...
                        >
                            ...
                            <h2 className="text-3xl font-bold text-white mt-4 mb-5">Chronosymbiosis</h2>
                            <p className="text-gray-400 leading-relaxed mb-4">
                                Most simulations resolve one decision at a time. Last Prompt does not. The engine is built around a single design principle: your decisions don&apos;t vanish after one moment — they resonate forward across time.
                            </p>
                            <p className="text-gray-400 leading-relaxed">
                        ...
                        >
                            ...
                            <p className="text-gray-400 text-sm leading-relaxed mb-5">
                                In Last Prompt: advisors are limited-patch observers. The AI evaluator enforces consistency. Outcomes emerge from the quality of the player&apos;s synthesis across partial perspectives. This parallel was confirmed by the physicist who developed the framework.
                            </p>
                            <Link
